...
insert into public.companies (id,num,company,instrument,bucket,ccy,invested,cap,discount,payment_date,maturity_date,extended_to,next_trigger,trigger_basis,status,issue_type,priority,situation,next_action,owner,due,legal_next,legal_req,target_feedback,vc_track,vc_plan,last_updated,legal_raised_at) values
('co1', 1, 'Agel', 'CN', 'Watchlist', 'USD', 125000.0, 4800000.0, 0.2, '2023-06-14', '2025-06-14', null, 'Maturity', 'QEF USD 1.0m; Target Financing USD 1.0m; 24m from payment', 'Waiting on company', 'Investment Issue', 'No Action', '• 25 August call with Reem: the company has signed a deal with Alkan, is heading to LEAP shortly, and is finalising its business plan.
...
('co2', 2, 'Amanleek', 'CN', 'Stable', 'USD', 125000.0, 3000000.0, 0.2, '2023-06-14', '2025-06-14', null, 'Maturity', 'QEF USD 2.0m; Target Financing USD 10.0m; 24m from payment', 'Waiting on company', 'Both', 'Immediate', '• Preferred shares issuance process is ongoing ahead of conversion.
...
('co3', 3, 'Belmazad', 'CLN', 'Stable', 'EGP', 14000000.0, 114000000.0, 0.3, '2024-12-27', '2026-12-27', null, 'Maturity', 'Equity Financing EGP 19.0m; cap EGP 114.0m pre-money; maturity 24m from first drawdown (date not recorded)', 'Decision due', 'Both', 'Near-Term', '• Founders requested an extension of the note term.
...
('co4', 4, 'Bringy', 'CN', 'Watchlist', 'USD', 125000.0, 6000000.0, 0.2, '2023-06-14', '2025-06-14', null, 'Maturity', 'QEF USD 2.0m; Target Financing USD 10.0m; 24m from payment', 'Waiting on company', 'Investment Issue', 'No Action', '• Q2 update shared on 19 August.
...
('co5', 5, 'Connect Money', 'SAFE', 'Growing', 'USD', 1000000.0, 15000000.0, 0.5, '2024-07-31', '2026-07-31', null, 'Maturity', 'Matured 31 Jul 2026. Section 1(e): converts on written demand by the Investor OR the Majority-in-Interest, at the Safe Price (cap / Company Capitalization) with NO discount. The SAFE contains no extension mechanism; if no demand is made it simply stays outstanding. Section 1(a) Equity Financing conversion instead gives the BETTER of Safe Price or a 50% discount to the round price. SAFE-2 issues SAFEs, not Preferred Shares at a fixed pre-money valuation, so it may not itself trigger 1(a).', 'In progress', 'Both', 'Immediate', '• 27 Aug cap table: the company converts EVERY SAFE T1 holder at USD 23m, giving BM 921,645 shares, 4.35%. Our USD 15m valuation cap is  applied as 8m + the 15m cap.', 'Confirm dilution and share price calculation', 'Rafik', '31 Aug 2026', 'YES', 'Confirm how our share is currently calculated', '2 working days', 'Banking services', 'Support company in credit facility', '2026-08-30', '2026-08-30T09:00:00.000Z'),
('co6', 6, 'Flash', 'SHA', 'Stable', 'USD', 125000.0, null, null, '2024-02-28', null, null, null, null, 'On track', 'No Issue', 'No Action', '• Company is stable and is sharing regular updates.', '• Continue monitoring information rights and governance compliance.', 'Rafik', '31 Oct 2026', 'NO', null, null, 'None currently', null, '2026-08-30', null),
('co7', 7, 'Flend', 'CN', 'Growing', 'USD', 125000.0, 6000000.0, 0.2, '2024-02-28', '2026-02-28', '2026-08-28', 'Financing round', 'QEF USD 2.0m; Target Financing USD 3.0m; 24m from payment', 'Decision due', 'Both', 'Immediate', '• Dilution calculation finalised after discussions with Sawari Ventures, the lead investor in the round.
...
('co8', 8, 'Seqoon', 'CN', 'Pivoting', 'USD', 125000.0, 6000000.0, 0.2, '2023-06-14', '2025-06-14', null, 'Financing round', 'QEF USD 1.0m; Target Financing USD 3.0m; claimed financing USD 750k cash + USD 250k in kind', 'Disputed', 'Both', 'Immediate', '• Conversion notice served claiming a QEF of USD 750k cash plus USD 250k in kind from a family-related investor (HDFO). The claimed total only reaches the USD 1.0m threshold if the in-kind component counts.
...
('co9', 9, 'Settle', 'CN', 'Watchlist', 'USD', 125000.0, 10000000.0, 0.2, '2024-02-28', '2026-02-28', '2028-02-29', 'Maturity', 'QEF USD 4.0m; Target Financing USD 5.0m; 24m from payment', 'On track', 'Investment Issue', 'Near-Term', '• 26 August: extension notice sent to the company, signed and returned the same day. The legal item is closed.
...
('co10', 10, 'Subsbase', 'CN', 'Wind down', 'USD', 125000.0, 10000000.0, 0.2, '2023-06-22', null, null, 'Wind-down', 'QEF USD 10.0m; Target Financing USD 15.0m; note counterparty is SubsBase Inc (BVI)', 'In progress', 'Both', 'Immediate', '• The Fawry asset sale collapsed and the company has initiated liquidation of the Egyptian entity. Our note is with the BVI company.
...
('co11', 11, 'Unlock', 'CN', 'Wind down', 'USD', 125000.0, 3000000.0, 0.2, '2024-02-28', '2026-02-28', null, 'Maturity', 'QEF USD 300k; Target Financing USD 600k; 24m from payment', 'Waiting on company', 'Investment Issue', 'Near-Term', '• 26 August: extension notice reviewed by legal counsel and sent to the company. The legal item is closed.
...
('co12', 12, 'Zammit', 'CN', 'Wind down', 'USD', 125000.0, 10000000.0, 0.2, '2023-06-14', '2025-06-14', null, 'Sale or IPO', 'Acquihire by Zid; QEF USD 4.0m; Target Financing USD 7.0m', 'In progress', 'Both', 'Immediate', '• Company entered an acquihire agreement with Zid (Saudi). Signed conversion agreements received 3 June; budget and May/June performance reports received 15 July after repeated chasing.
...
('lists', '{"priority": ["Immediate", "Near-Term", "Postponed", "No Action"], "issueType": ["Legal Issue", "Investment Issue", "Both", "No Issue"], "bucket": ["Growing", "Stable", "Watchlist", "Pivoting", "Wind down"], "trigger": ["Maturity", "Financing round", "Sale or IPO", "Wind-down"], "track": ["Venture clienting", "Banking services", "Capacity building & acceleration", "Business model & market study", "None currently"], "yesNo": ["YES", "NO"], "status": ["On track", "Decision due", "Waiting on company", "In progress", "Disputed"]}'::jsonb),
('fx', '50'::jsonb),
