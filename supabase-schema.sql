...
insert into public.companies (id,num,company,instrument,bucket,ccy,invested,cap,discount,payment_date,maturity_date,extension,next_trigger,trigger_basis,trigger_status,issue_type,priority,situation,next_action,owner,due,legal_next,legal_req,target_feedback,vc_track,vc_plan,last_updated,legal_raised_at) values
('co1', 1, 'Agel', 'CN', 'Watchlist', 'USD', 125000.0, 4800000.0, 0.2, '2023-06-14', '2025-06-14', 'Extended', 'Maturity / Maturity Event', 'QEF USD 1.0m; Target Financing USD 1.0m; 24m from payment', 'Extended', 'Investment Issue', 'No Action', '• 25 August call with Reem: the company has signed a deal with Alkan, is heading to LEAP shortly, and is finalising its business plan.
• The business plan will be shared soon.', '• Review the business plan once the company shares it.', 'Reem', '30 Sep 2026', 'NO', null, null, 'Business model & market study', 'Review the business case upoin sharing', '2026-08-30', null),
('co2', 2, 'Amanleek', 'CN', 'Stable', 'USD', 125000.0, 3000000.0, 0.2, '2023-06-14', '2025-06-14', 'Not extended', 'Maturity / Maturity Event', 'QEF USD 2.0m; Target Financing USD 10.0m; 24m from payment', 'Passed', 'Both', 'Immediate', '• Preferred shares issuance process is ongoing ahead of conversion.
• Company received an extension from the FRA that expires this year.
• Followed up by email on Sunday 23 August; Reem sent a further follow-up on 30 August pushing for a timeline. No response yet.
• NOTE: this is the only note in the portfolio past maturity that has NOT been extended. It matured 14 June 2025.', '• Press for a firm issuance timeline so the year-end FRA deadline is met.
...
('co3', 3, 'Belmazad', 'CLN', 'Stable', 'EGP', 14000000.0, 114000000.0, 0.3, null, '2026-12-31', 'Under decision', 'Maturity / Maturity Event', 'Equity Financing EGP 19.0m; cap EGP 114.0m pre-money; maturity 24m from first drawdown (date not recorded)', 'Not yet triggered', 'Both', 'Near-Term', '• Founders requested an extension of the note term.
• 25 August: Misr Capital shared a valuation report by Karvy valuing Belmazad at EGP 270m. Misr Capital recommends extending, since we convert at the cap either way and we accrue interest during the extension period.
• 27 August: Mina emailed Shawarby requesting legal advice on the extension request.
• Awaiting Shawarby''s advice.', '• Follow up for Shawarby''s advice.
...
('co4', 4, 'Bringy', 'CN', 'Watchlist', 'USD', 125000.0, 6000000.0, 0.2, '2023-06-14', '2025-06-14', 'Extended', 'Maturity / Maturity Event', 'QEF USD 2.0m; Target Financing USD 10.0m; 24m from payment', 'Extended', 'Investment Issue', 'No Action', '• Q2 update shared on 19 August.
• Revenue is slowly increasing and margins are improving, but the company is still burning.
• Q2 revenue EGP 900k; net loss EGP 1.5m.
• Not yet profitable.', '• No action required; continue quarterly monitoring.', 'Rafik', '31 Oct 2026 (Q3)', 'NO', null, null, 'None currently', null, '2026-08-30', null),
('co5', 5, 'Connect Money', 'SAFE', 'Growing', 'USD', 1000000.0, 15000000.0, 0.5, '2024-07-31', '2026-07-31', 'Matured - no extension mechanism', 'Maturity / Maturity Event', 'Matured 31 Jul 2026. Section 1(e): converts on written demand by the Investor OR the Majority-in-Interest, at the Safe Price (cap / Company Capitalization) with NO discount. The SAFE contains no extension mechanism; if no demand is made it simply stays outstanding. Section 1(a) Equity Financing conversion instead gives the BETTER of Safe Price or a 50% discount to the round price. SAFE-2 issues SAFEs, not Preferred Shares at a fixed pre-money valuation, so it may not itself trigger 1(a).', 'Live now', 'Both', 'Immediate', '• 27 Aug cap table: the company converts EVERY SAFE T1 holder at USD 23m, giving BM 921,645 shares, 4.35%. Our USD 15m valuation cap is  applied as 8m + the 15m cap.', 'Confirm dilution and share price calculation', 'Rafik', '31 Aug 2026', 'YES', 'Confirm how our share is currently calculated', '2 working days', 'Banking services', 'Support company in credit facility', '2026-08-30', '2026-08-30T09:00:00.000Z'),
('co6', 6, 'Flash', 'SHA', 'Stable', 'USD', 125000.0, null, null, '2024-02-28', null, 'N/A', null, null, 'Watching', 'No Issue', 'No Action', '• Company is stable and is sharing regular updates.
', '• Continue monitoring information rights and governance compliance.', 'Rafik', '31 Oct 2026', 'NO', null, null, 'None currently', null, '2026-08-30', null),
('co7', 7, 'Flend', 'CN', 'Growing', 'USD', 125000.0, 6000000.0, 0.2, '2024-02-28', '2026-02-28', 'Extended', 'Qualified Equity Financing', 'QEF USD 2.0m; Target Financing USD 3.0m; 24m from payment', 'Live now', 'Both', 'Immediate', '• Dilution calculation finalised after discussions with Sawari Ventures, the lead investor in the round.
• Conversion is automatic once the Series A completes; a decision only arises if the round does not close.
• 25 August: Misr Capital recommended extending the note by three months so that it runs until the round closes.
• Reem has asked why three months rather than six, which would give more certainty the round closes without having to extend again.', '• Obtain Misr Capital''s rationale for the three-month term, then decide the extension length.', 'Reem', '15 Sep 2026', 'YES', 'Get feedback on the implication of the extension (as per the details shared with Mina earlier by email).', '1 working day', 'Banking services', 'Suppot in credit facility and develop data sharing mechanism to develop ring fenced credit facility', '2026-08-30', '2026-08-30T09:00:00.000Z'),
('co8', 8, 'Seqoon', 'CN', 'Pivoting', 'USD', 125000.0, 6000000.0, 0.2, '2023-06-14', '2025-06-14', 'Extended', 'Qualified Equity Financing', 'QEF USD 1.0m; Target Financing USD 3.0m; claimed financing USD 750k cash + USD 250k in kind', 'Disputed', 'Both', 'Immediate', '• Conversion notice served claiming a QEF of USD 750k cash plus USD 250k in kind from a family-related investor (HDFO). The claimed total only reaches the USD 1.0m threshold if the in-kind component counts.
• 23 August: Reem emailed Seqoon requesting the evidence and documentation needed to test validity. Counsel is reserving its position pending the cap table, bank evidence and in-kind support.
• Counsel recommends negotiating a commercial exit at 2x opening and 1x floor rather than enforcing.', '• Follow up with Seqoon for the documentation requested on 23 August: bank statements, in-kind evidence, valuation justification.
...
('co9', 9, 'Settle', 'CN', 'Watchlist', 'USD', 125000.0, 10000000.0, 0.2, '2024-02-28', '2026-02-28', 'Extended', 'Maturity / Maturity Event', 'QEF USD 4.0m; Target Financing USD 5.0m; 24m from payment', 'Extended', 'Investment Issue', 'Near-Term', '• 26 August: extension notice sent to the company, signed and returned the same day. The legal item is closed.
• Company is still pre-revenue and has been in final stages of testing since June.', '• Obtain an update on client onboarding and the expected go-live date.', 'Rafik', '30 Sep 2026', 'NO', null, null, 'Banking services', 'Match with Flend and support in SWIFT process.', '2026-08-30', null),
('co10', 10, 'Subsbase', 'CN', 'Wind down', 'USD', 125000.0, 10000000.0, 0.2, '2023-06-22', '2025-06-22', 'Extended', 'Dissolution Event', 'QEF USD 10.0m; Target Financing USD 15.0m; note counterparty is SubsBase Inc (BVI)', 'Live now', 'Both', 'Immediate', '• The Fawry asset sale collapsed and the company has initiated liquidation of the Egyptian entity. Our note is with the BVI company.
• Counsel 26 August: the open question is whether the software and IP sit in the BVI company or the Egyptian opco. If the opco owns it, the Clause 4(f) IP representation may be inaccurate. Write-off is explicitly on the table.
• 30 August: information request sent to the founders, rights expressly reserved and Sections 3(c) and 3(d) cited so no distribution is made to founders or shareholders ahead of the note. Awaiting reply.', '• Await the founders'' response to the 30 August request; escalate if nothing is received.
...
('co11', 11, 'Unlock', 'CN', 'Wind down', 'USD', 125000.0, 3000000.0, 0.2, '2024-02-28', '2026-02-28', 'Extended', 'Maturity / Maturity Event', 'QEF USD 300k; Target Financing USD 600k; 24m from payment', 'Extended', 'Investment Issue', 'Near-Term', '• 26 August: extension notice reviewed by legal counsel and sent to the company. The legal item is closed.
• Company has run out of cash and is trying to raise funds or onboard a long-term client.', '• Put the recommendation to place the company in the wind-down bucket and stop routine communication and updates.', 'Rafik', '30 Sep 2026', 'NO', null, null, 'None currently', 'No support work; wind down recommended.', '2026-08-30', null),
('co12', 12, 'Zammit', 'CN', 'Wind down', 'USD', 125000.0, 10000000.0, 0.2, '2023-06-14', '2025-06-14', 'Extended', 'Liquidity Event (Change of Control or IPO)', 'Acquihire by Zid; QEF USD 4.0m; Target Financing USD 7.0m', 'Live now', 'Both', 'Immediate', '• Company entered an acquihire agreement with Zid (Saudi). Signed conversion agreements received 3 June; budget and May/June performance reports received 15 July after repeated chasing.
• 24 August: Misr Capital advised that all updated financials are needed to support the decision, and noted the company has not shared them. 25 August: Reem requested opco and holdco financials. Still outstanding.
• Restructure agreement terms are not yet agreed.', '• Follow up on the opco and holdco financials requested on 25 August.
...
('lists', '{"priority": ["Immediate", "Near-Term", "Postponed", "No Action"], "issueType": ["Legal Issue", "Investment Issue", "Both", "No Issue"], "bucket": ["Growing", "Stable", "Watchlist", "Pivoting", "Wind down"], "trigger": ["Qualified Equity Financing", "Target Financing", "Optional Conversion Event", "Equity Financing (CLN / SAFE)", "Maturity / Maturity Event", "Liquidity Event (Change of Control or IPO)", "Dissolution Event", "Investor termination (false representation)"], "triggerStatus": ["Passed", "Live now", "Disputed", "Extended", "Watching", "Not yet triggered"], "extension": ["Extended", "Not extended", "Under decision", "Matured - no extension mechanism", "Not yet matured", "N/A"], "track": ["Venture clienting", "Banking services", "Capacity building & acceleration", "Business model & market study", "None currently"], "yesNo": ["YES", "NO"]}'::jsonb),
('fx', '50'::jsonb),
