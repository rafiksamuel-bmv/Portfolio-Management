...
('co9', 9, 'Settle', 'CN', 'Watchlist', 'USD', 125000.0, 10000000.0, 0.2, '2024-02-28', '2026-02-28', null, 'Maturity', 'QEF USD 4.0m; Target Financing USD 5.0m; 24m from payment', 'On track', 'Investment Issue', 'Near-Term', '• 26 August: extension notice sent to the company, signed and returned the same day. The legal item is closed.
