...
('co10', 10, 'Subsbase', 'CN', 'Wind down', 'USD', 125000.0, 10000000.0, 0.2, '2023-06-22', null, null, 'Acquihire / Dissolution / Liquidation', 'QEF USD 10.0m; Target Financing USD 15.0m; note counterparty is SubsBase Inc (BVI)', 'In progress', 'Both', 'Immediate', '• Await the founders'' response to the 30 August request; escalate if nothing is received.
...
('co12', 12, 'Zammit', 'CN', 'Wind down', 'USD', 125000.0, 10000000.0, 0.2, '2023-06-14', '2025-06-14', null, 'Acquihire / Dissolution / Liquidation', 'Acquihire by Zid; QEF USD 4.0m; Target Financing USD 7.0m', 'In progress', 'Both', 'Immediate', '• Follow up on the opco and holdco financials requested on 25 August.
...
('lists', '{"priority": ["Immediate", "Near-Term", "Postponed", "No Action"], "issueType": ["Legal Issue", "Investment Issue", "Both", "No Issue"], "bucket": ["Growing", "Stable", "Watchlist", "Pivoting", "Wind down"], "trigger": ["Maturity", "Financing round", "Sale or IPO", "Acquihire / Dissolution / Liquidation"], "track": ["Venture clienting", "Banking services", "Capacity building & acceleration", "Business model & market study", "None currently"], "yesNo": ["YES", "NO"], "status": ["On track", "Decision due", "Waiting on company", "In progress", "Disputed"]}'::jsonb),
('fx', '50'::jsonb),
