...
('co2', 2, 'Amanleek', 'CN', 'Stable', 'USD', 125000.0, 3000000.0, 0.2, '2023-06-14', '2025-06-14', null, 'Maturity', 'QEF USD 2.0m; Target Financing USD 10.0m; 24m from payment', 'Pending company', 'Both', 'Immediate', '• Press for a firm issuance timeline so the year-end FRA deadline is met.
...
('co3', 3, 'Belmazad', 'CLN', 'Stable', 'EGP', 14000000.0, 114000000.0, 0.3, '2024-12-27', '2026-12-27', null, 'Maturity', 'Equity Financing EGP 19.0m; cap EGP 114.0m pre-money; maturity 24m from first drawdown (date not recorded)', 'Pending legal', 'Both', 'Near-Term', '• Follow up for Shawarby''s advice.
...
('co5', 5, 'Connect Money', 'SAFE', 'Growing', 'USD', 1000000.0, 15000000.0, 0.5, '2024-07-31', '2026-07-31', null, 'Maturity', 'Matured 31 Jul 2026. Section 1(e): converts on written demand by the Investor OR the Majority-in-Interest, at the Safe Price (cap / Company Capitalization) with NO discount. The SAFE contains no extension mechanism; if no demand is made it simply stays outstanding. Section 1(a) Equity Financing conversion instead gives the BETTER of Safe Price or a 50% discount to the round price. SAFE-2 issues SAFEs, not Preferred Shares at a fixed pre-money valuation, so it may not itself trigger 1(a).', 'Pending legal', 'Both', 'Immediate', 'Confirm dilution and share price calculation', 'Rafik', '31 Aug 2026', 'YES', 'Confirm how our share is currently calculated', '2 working days', 'Banking services', 'Support company in credit facility', '2026-08-30', '2026-08-30T09:00:00.000Z'),
...
('co10', 10, 'Subsbase', 'CN', 'Wind down', 'USD', 125000.0, 10000000.0, 0.2, '2023-06-22', null, null, 'Acquihire / Dissolution / Liquidation', 'QEF USD 10.0m; Target Financing USD 15.0m; note counterparty is SubsBase Inc (BVI)', 'Pending company', 'Both', 'Immediate', '• Await the founders'' response to the 30 August request; escalate if nothing is received.
...
('co12', 12, 'Zammit', 'CN', 'Wind down', 'USD', 125000.0, 10000000.0, 0.2, '2023-06-14', '2025-06-14', null, 'Acquihire / Dissolution / Liquidation', 'Acquihire by Zid; QEF USD 4.0m; Target Financing USD 7.0m', 'Pending legal', 'Both', 'Immediate', '• Follow up on the opco and holdco financials requested on 25 August.
