...
('co1', 1, 'Agel', 'CN', 'Watchlist', 'USD', 125000.0, 4800000.0, 0.2, '2023-06-14', '2025-06-14', null, 'Maturity', 'QEF USD 1.0m; Target Financing USD 1.0m; 24m from payment', 'Waiting on company', 'Investment Issue', 'No Action', '• Review the business plan once the company shares it.', 'Reem', '30 Sep 2026', 'NO', null, null, 'Business model & market study', 'Review the business case upoin sharing', '2026-08-30', null),
('co2', 2, 'Amanleek', 'CN', 'Stable', 'USD', 125000.0, 3000000.0, 0.2, '2023-06-14', '2025-06-14', null, 'Maturity', 'QEF USD 2.0m; Target Financing USD 10.0m; 24m from payment', 'Waiting on company', 'Both', 'Immediate', '• Press for a firm issuance timeline so the year-end FRA deadline is met.
...
('co3', 3, 'Belmazad', 'CLN', 'Stable', 'EGP', 14000000.0, 114000000.0, 0.3, '2024-12-27', '2026-12-27', null, 'Maturity', 'Equity Financing EGP 19.0m; cap EGP 114.0m pre-money; maturity 24m from first drawdown (date not recorded)', 'Decision due', 'Both', 'Near-Term', '• Follow up for Shawarby''s advice.
...
('co4', 4, 'Bringy', 'CN', 'Watchlist', 'USD', 125000.0, 6000000.0, 0.2, '2023-06-14', '2025-06-14', null, 'Maturity', 'QEF USD 2.0m; Target Financing USD 10.0m; 24m from payment', 'Waiting on company', 'Investment Issue', 'No Action', '• No action required; continue quarterly monitoring.', 'Rafik', '31 Oct 2026 (Q3)', 'NO', null, null, 'None currently', null, '2026-08-30', null),
('co5', 5, 'Connect Money', 'SAFE', 'Growing', 'USD', 1000000.0, 15000000.0, 0.5, '2024-07-31', '2026-07-31', null, 'Maturity', 'Matured 31 Jul 2026. Section 1(e): converts on written demand by the Investor OR the Majority-in-Interest, at the Safe Price (cap / Company Capitalization) with NO discount. The SAFE contains no extension mechanism; if no demand is made it simply stays outstanding. Section 1(a) Equity Financing conversion instead gives the BETTER of Safe Price or a 50% discount to the round price. SAFE-2 issues SAFEs, not Preferred Shares at a fixed pre-money valuation, so it may not itself trigger 1(a).', 'In progress', 'Both', 'Immediate', 'Confirm dilution and share price calculation', 'Rafik', '31 Aug 2026', 'YES', 'Confirm how our share is currently calculated', '2 working days', 'Banking services', 'Support company in credit facility', '2026-08-30', '2026-08-30T09:00:00.000Z'),
...
('co7', 7, 'Flend', 'CN', 'Growing', 'USD', 125000.0, 6000000.0, 0.2, '2024-02-28', '2026-02-28', '2026-08-28', 'Financing round', 'QEF USD 2.0m; Target Financing USD 3.0m; 24m from payment', 'Decision due', 'Both', 'Immediate', '• Obtain Misr Capital''s rationale for the three-month term, then decide the extension length.', 'Reem', '15 Sep 2026', 'YES', 'Get feedback on the implication of the extension (as per the details shared with Mina earlier by email).', '1 working day', 'Banking services', 'Suppot in credit facility and develop data sharing mechanism to develop ring fenced credit facility', '2026-08-30', '2026-08-30T09:00:00.000Z'),
('co8', 8, 'Seqoon', 'CN', 'Pivoting', 'USD', 125000.0, 6000000.0, 0.2, '2023-06-14', '2025-06-14', null, 'Financing round', 'QEF USD 1.0m; Target Financing USD 3.0m; claimed financing USD 750k cash + USD 250k in kind', 'Disputed', 'Both', 'Immediate', '• Follow up with Seqoon for the documentation requested on 23 August: bank statements, in-kind evidence, valuation justification.
...
('co10', 10, 'Subsbase', 'CN', 'Wind down', 'USD', 125000.0, 10000000.0, 0.2, '2023-06-22', null, null, 'Wind-down', 'QEF USD 10.0m; Target Financing USD 15.0m; note counterparty is SubsBase Inc (BVI)', 'In progress', 'Both', 'Immediate', '• Await the founders'' response to the 30 August request; escalate if nothing is received.
...
('co11', 11, 'Unlock', 'CN', 'Wind down', 'USD', 125000.0, 3000000.0, 0.2, '2024-02-28', '2026-02-28', null, 'Maturity', 'QEF USD 300k; Target Financing USD 600k; 24m from payment', 'Waiting on company', 'Investment Issue', 'Near-Term', '• Put the recommendation to place the company in the wind-down bucket and stop routine communication and updates.', 'Rafik', '30 Sep 2026', 'NO', null, null, 'None currently', 'No support work; wind down recommended.', '2026-08-30', null),
('co12', 12, 'Zammit', 'CN', 'Wind down', 'USD', 125000.0, 10000000.0, 0.2, '2023-06-14', '2025-06-14', null, 'Sale or IPO', 'Acquihire by Zid; QEF USD 4.0m; Target Financing USD 7.0m', 'In progress', 'Both', 'Immediate', '• Follow up on the opco and holdco financials requested on 25 August.
