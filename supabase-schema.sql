...
insert into public.companies (id,num,company,instrument,bucket,ccy,invested,cap,discount,payment_date,maturity_date,extended_to,next_trigger,trigger_basis,status,issue_type,priority,next_action,closure,owner,due,legal_next,legal_req,target_feedback,vc_track,vc_plan,last_updated,legal_raised_at) values
('co1', 1, 'Agel', 'CN', 'Watchlist', 'USD', 125000.0, 4800000.0, 0.2, '2023-06-14', '2025-06-14', null, 'Maturity', 'QEF USD 1.0m; Target Financing USD 1.0m; 24m from payment', 'Pending company', 'Investment Issue', 'No Action', '• Review the business plan once the company shares it.', null, 'Reem', '30 Sep 2026', 'NO', null, null, 'Business model & market study', 'Review the business case upoin sharing', '2026-08-30', null),
...
• Decide whether to extend the note, or confirm why an extension is not required here.', null, 'Reem', '31 Dec 2026 (FRA)', 'NO', null, null, 'Banking services', 'We have shared a payroll offer', '2026-08-30', null),
...
• Decide whether to approve the extension once legal input is received.', null, 'Mina', '30 Sep 2026', 'YES', 'Get feedback on the implication of the extension (already sent by Mina to Shawarby and follow up sent on the 30th of August).', '2 working days (End of 31st)', 'Venture clienting', 'Hold until the extension decision is made. But later on, considering that Belmazad is a good venture clienting case, discuss with company how to keep the venture clienting process operational and expand on it.', '2026-08-30', '2026-08-30T09:00:00.000Z'),
('co4', 4, 'Bringy', 'CN', 'Watchlist', 'USD', 125000.0, 6000000.0, 0.2, '2023-06-14', '2025-06-14', null, 'Maturity', 'QEF USD 2.0m; Target Financing USD 10.0m; 24m from payment', 'Pending company', 'Investment Issue', 'No Action', '• No action required; continue quarterly monitoring.', null, 'Rafik', '31 Oct 2026 (Q3)', 'NO', null, null, 'None currently', null, '2026-08-30', null),
('co5', 5, 'Connect Money', 'SAFE', 'Growing', 'USD', 1000000.0, 15000000.0, 0.5, '2024-07-31', '2026-07-31', null, 'Maturity', 'Matured 31 Jul 2026. Section 1(e): converts on written demand by the Investor OR the Majority-in-Interest, at the Safe Price (cap / Company Capitalization) with NO discount. The SAFE contains no extension mechanism; if no demand is made it simply stays outstanding. Section 1(a) Equity Financing conversion instead gives the BETTER of Safe Price or a 50% discount to the round price. SAFE-2 issues SAFEs, not Preferred Shares at a fixed pre-money valuation, so it may not itself trigger 1(a).', 'Pending legal', 'Investment & Legal', 'Immediate', 'Confirm dilution and share price calculation', null, 'Rafik', '31 Aug 2026', 'YES', 'Confirm how our share is currently calculated', '2 working days', 'Banking services', 'Support company in credit facility', '2026-08-30', '2026-08-30T09:00:00.000Z'),
('co6', 6, 'Flash', 'SHA', 'Stable', 'USD', 125000.0, null, null, '2024-02-28', null, null, null, null, 'On track', 'No Issue', 'No Action', '• Continue monitoring information rights and governance compliance.', null, 'Rafik', '31 Oct 2026', 'NO', null, null, 'None currently', null, '2026-08-30', null),
('co7', 7, 'Flend', 'CN', 'Growing', 'USD', 125000.0, 6000000.0, 0.2, '2024-02-28', '2026-02-28', '2026-08-28', 'Financing round', 'QEF USD 2.0m; Target Financing USD 3.0m; 24m from payment', 'Pending legal', 'Investment & Legal', 'Immediate', '• Obtain Misr Capital''s rationale for the three-month term, then decide the extension length.', null, 'Reem', '15 Sep 2026', 'YES', 'Get feedback on the implication of the extension (as per the details shared with Mina earlier by email).', '1 working day', 'Banking services', 'Suppot in credit facility and develop data sharing mechanism to develop ring fenced credit facility', '2026-08-30', '2026-08-30T09:00:00.000Z'),
...
• Hold the conversion decision until the validity of the QEF is established.', null, 'Reem', '15 Sep 2026', 'NO', null, null, 'None currently', 'No support work while the conversion dispute is open.', '2026-08-30', null),
('co9', 9, 'Settle', 'CN', 'Watchlist', 'USD', 125000.0, 10000000.0, 0.2, '2024-02-28', '2026-02-28', '2028-02-29', 'Maturity', 'QEF USD 4.0m; Target Financing USD 5.0m; 24m from payment', 'On track', 'Investment Issue', 'Near-Term', '• Obtain an update on client onboarding and the expected go-live date.', null, 'Rafik', '30 Sep 2026', 'NO', null, null, 'Banking services', 'Match with Flend and support in SWIFT process.', '2026-08-30', null),
...
• Negotiate a settlement before formal steps; then decide between recovery and write-off.', null, 'Rafik', '15 Sep 2026', 'NO', null, null, 'None currently', 'No support work; company in liquidation.', '2026-08-30', null),
('co11', 11, 'Unlock', 'CN', 'Wind down', 'USD', 125000.0, 3000000.0, 0.2, '2024-02-28', '2026-02-28', null, 'Maturity', 'QEF USD 300k; Target Financing USD 600k; 24m from payment', 'Pending company', 'Investment Issue', 'Near-Term', '• Put the recommendation to place the company in the wind-down bucket and stop routine communication and updates.', null, 'Rafik', '30 Sep 2026', 'NO', null, null, 'None currently', 'No support work; wind down recommended.', '2026-08-30', null),
...
• Agree the final terms of the restructure agreement.', null, 'Reem', '15 Sep 2026', 'YES', 'Legal review on the agreement and whether there is any breach (as per the draft shared earlier by Mina).', '2 working days', 'None currently', 'No support work; acquihire and restructure in progress.', '2026-08-30', '2026-08-30T09:00:00.000Z')
on conflict (id) do nothing;
